...
{
    /// <summary>
    /// Android implementation of InterstitialAd using Google Mobile Ads SDK.
    /// </summary>
    public partial class InterstitialAd
    {
        private InterstitialAdClass? _interstitialAd;
        ...
        partial void ShowPartial()
        {
            ...
            {
                RaiseAdFailedToShow(new AdError(-1, "Interstitial ad is not loaded", "Android"));
                return;
            }
        ...
        private class InterstitialAdLoadCallback : InterstitialAdLoadCallbackClass
        {
            private readonly InterstitialAd _owner;

            public InterstitialAdLoadCallback(InterstitialAd owner)
            {
                _owner = owner;
            }

            public override void OnAdLoaded(InterstitialAdClass interstitialAd)
            {
                _owner._interstitialAd = interstitialAd;
                _owner._interstitialAd.FullScreenContentCallback = new InterstitialAdCallback(_owner);
        ...
        private class InterstitialAdCallback : FullScreenContentCallback
        {
            ...
            public InterstitialAdCallback(InterstitialAd owner)
            {
                _owner = owner;
            }
